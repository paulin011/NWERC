...
% Reduce overall document font size to 8pt by selecting a smaller normalsize at begin document.
% This makes the whole document denser without changing class options.
\AtBeginDocument{%
