...
\setlength{\parskip}{0pt}% remove extra vertical gaps
\setlength{\columnsep}{3pt} % tighter columns to save space
\titlespacing*{\section}{0pt}{4pt}{1pt}
\titlespacing*{\subsection}{0pt}{2pt}{0.5pt}
\setlist{nosep, leftmargin=*}

% Reduce overall document font size to 7pt at begin document to compress the layout.
\AtBeginDocument{%
...
\begingroup\scriptsize\setlength{\parskip}{0pt}\tableofcontents\endgroup
\end{multicols}
